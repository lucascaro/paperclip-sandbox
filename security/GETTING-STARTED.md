...
This downloads the npm packages without executing them and searches for dangerous patterns.
...
- eval() or Function() with dynamic, user-controlled input
- Network calls to unrecognized endpoints
- Detached background process creation
- S3 upload patterns or cloud exfiltration
...
| `./security/static-scan.sh` | Download and grep packages (no execution) |
